...
public class Lista implements Iterable<NodoUno>{
	
	
    // Puntero que indica el inicio de la lista o conocida tambien
    // como cabeza de la lista.
    private NodoUno nodoPrimero;
    ...
    public void insertarPorReferencia(int referencia, int valor){
        ...
        if (!esVacia()) {
            ...
            if (buscar(referencia)) {
                ...
                NodoUno siguiente = aux.getSiguiente();
    ...
    public NodoUno buscarNodo(int referencia){
    ...
    public int eliminar(int referencia){
    	...
    	NodoUno nodo = nodoPrimero;
    	NodoUno previo = null;
    	NodoUno siguiente = null;
    	boolean encontrado = false;
    ...
    public void removerPorReferencia(int referencia){
        ...
        if (buscar(referencia)) {
            ...
            if (nodoPrimero.getValor() == referencia) {
                ...
                NodoUno siguiente = aux.getSiguiente().getSiguiente();
    ...
    @Override
    public Iterator<NodoUno> iterator() {
    	return new IteradorListaSimple(nodoPrimero);
    }
    
    public class IteradorListaSimple implements Iterator<NodoUno>{

		private NodoUno nodo;
		private int posicion;
		
    	public IteradorListaSimple(NodoUno nodo) {
			this.nodo = nodo;
			this.posicion = 0;
		}
